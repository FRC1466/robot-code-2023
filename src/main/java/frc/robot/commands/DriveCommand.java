...
public class DriveCommand extends CommandBase {
  ...
  private void drive() {
    if (!controller.getRawButton(2)) {
      vx =
          controllerInput(
              controller.getY(), OIConstants.InputLimits.vxDeadband, OIConstants.InputLimits.vx);
      vy =
          controllerInput(
              controller.getX(), OIConstants.InputLimits.vyDeadband, OIConstants.InputLimits.vy);
      rad =
          controllerInput(
              controller.getZ(), OIConstants.InputLimits.radDeadband, OIConstants.InputLimits.rad);
    } else {
      vx =
          controllerInput(
              controller.getY(),
