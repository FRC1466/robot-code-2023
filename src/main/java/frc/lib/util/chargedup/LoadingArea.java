...
public class LoadingArea {
    ...
    public LoadingArea(RectanglePoseArea largeLoadingRect, RectanglePoseArea smallLoadingRect, HolonomicPose2d doubleSubstationLeft, HolonomicPose2d doubleSubstationRight) {
