...
public class BetterMath {
   ...
   * negative numbers but returns a negative number as a result.
   *
   ...
   */
  public static double absFunc(double input, DoubleFunction<Double> func) {
   ...
   */
  public static double absFunc(double signage, DoubleSupplier func) {
